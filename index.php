...
<head>
    ...
    <title>Baked Bean Project - Home/About</title>
    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="index.html">Baked-Bean</a>
            </div>
...
<!--                    <li>
    ...
    <header class="intro-header" style="background-image: url('img/bean-bg2.jpg')">
        <div class="container">
            <div class="row">
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <p class="copyright text-muted">Copyright &copy; Charlie Seaman 2019 <a href="HUMANS.TXT"><img src="img/humanstxt.gif" alt="HUMANS.TXT" width="88" height="31"></a></p>
                </div>
            </div>
        </div>
    </footer>
